...
public class UserRepositoryImpl implements UserRepository {
    ...
    @TransactionalAdvice
    @Override
    public User save(@NonNull @NotBlank String username, @NonNull @NotBlank String rawPassword) {
    ...
    @Override
    @Nullable
    public User findByUsername(@NonNull @NotBlank String username) {
    ...
    @TransactionalAdvice
    @Override
    public void delete(@NonNull @NotBlank String username) {
    ...
    @TransactionalAdvice
    @NonNull
    public List<String> findRolesByUsername(@NonNull @NotBlank String username) {
    ...
    @TransactionalAdvice
    public void addUserRole(@NonNull @NotBlank String username, @NonNull @NotNull Role role) {
        User user = findByUsername(username);
        if (user != null) {
            user.addRole(role);
